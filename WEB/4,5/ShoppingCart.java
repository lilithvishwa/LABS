...
String [] items = new String [] {
 ...
 "Samsung A30", "MI 108 CM Android TV", "HP USB Pend Drive 32GB", "DELL Core i5, 8GB RAM, 1TB HDD Laptop" };
 ...
 out.println( "<p><input type=submit name=add value=\"Add To Cart\">" + "<input type=submit name=checkout value=\"Check Out\">" + "<input type=submit name=clear value=\"Clear Cart\">"
 + "</form>" );
 }
